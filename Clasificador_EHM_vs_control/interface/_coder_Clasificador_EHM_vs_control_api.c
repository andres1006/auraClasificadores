 ...
 *
 * _coder_Clasificador_EHM_vs_control_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "Clasificador_EHM_vs_control",       /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
void Clasificador_EHM_vs_control_api(const mxArray * const prhs[1], int32_T nlhs,
  const mxArray *plhs[1])
{
  ...
  Clasificador_EHM_vs_control(x, label);
...
void Clasificador_EHM_vs_control_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  Clasificador_EHM_vs_control_xil_terminate();
}

void Clasificador_EHM_vs_control_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void Clasificador_EHM_vs_control_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_Clasificador_EHM_vs_control_api.c) */
