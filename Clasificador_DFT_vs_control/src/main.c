/*
 * Academic License - for use in tDFTching, academic research, and meeting
...
#include "main.h"
#include "Clasificador_DFT_vs_control_terminate.h"
#include "Clasificador_DFT_vs_control_emxAPI.h"
#include "Clasificador_DFT_vs_control_initialize.h"

/* Function Declarations */
static emxArray_real_T *argInit_Unboundedx12_real_T(char *vec[], int argc);
static double argInit_real_T(void);
static void main_Clasificador_DFT_vs_control(char *vec[], int size);
...
static void main_Clasificador_DFT_vs_control(char *vec[], int size)
{
  ...
  /* Initialize function 'Clasificador_DFT_vs_control' input arguments. */
  /* Initialize function input argument 'x'. */ 
  x = argInit_Unboundedx12_real_T(vec, size);

  /* Call the entry-point 'Clasificador_DFT_vs_control'. */
...
//envio el vector con los datos y el tamaño del vector
  main_Clasificador_DFT_vs_control(argv, argc);
