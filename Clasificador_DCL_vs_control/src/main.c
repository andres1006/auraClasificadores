...
#include "main.h"
#include "Clasificador_DCL_vs_control_terminate.h"
#include "Clasificador_DCL_vs_control_emxAPI.h"
#include "Clasificador_DCL_vs_control_initialize.h"

/* Function Declarations */
static emxArray_real_T *argInit_Unboundedx2_real_T(char *datos[], int argc);
static double argInit_real_T(void);
static void main_Clasificador_DCL_vs_control(char *vec[], int size);

/* Function Definitions */
static emxArray_real_T *argInit_Unboundedx2_real_T(char *vec[], int size)
{
...
int main(int argc,char  *argv[])
{
  ...
  //    You can call entry-point functions multiple times. Envio parametro de ruta y nombre del archivo a clasificar*/
  main_Clasificador_DCL_vs_control(argv, argc);
