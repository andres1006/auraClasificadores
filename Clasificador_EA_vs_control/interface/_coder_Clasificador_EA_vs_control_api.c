 ...
 *
 * _coder_Clasificador_EA_vs_control_api.c
 *
...
#include "_coder_Clasificador_EA_vs_control_mex.h"
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "Clasificador_EA_vs_control",        /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
void Clasificador_EA_vs_control_api(const mxArray * const prhs[1], int32_T nlhs,
...
void Clasificador_EA_vs_control_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  Clasificador_EA_vs_control_xil_terminate();
}

void Clasificador_EA_vs_control_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void Clasificador_EA_vs_control_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_Clasificador_EA_vs_control_api.c) */
