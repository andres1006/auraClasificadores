...
static void main_Clasificador_Parkinsionismos_vs_control(char *vec[], int size);
...
//envio el vector con los datos y el tamaño del vector
  main_Clasificador_Parkinsionismos_vs_control(argv, argc);
