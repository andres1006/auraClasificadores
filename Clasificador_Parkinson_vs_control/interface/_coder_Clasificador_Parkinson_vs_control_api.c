 ...
 *
 * _coder_Clasificador_Parkinson_vs_control_api.c
 *
...
#include "_coder_Clasificador_Parkinson_vs_control_mex.h"
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "Clasificador_Parkinson_vs_control", /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
void Clasificador_Parkinson_vs_control_api(const mxArray * const prhs[1],
...
void Clasificador_Parkinson_vs_control_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  Clasificador_Parkinson_vs_control_xil_terminate();
}

void Clasificador_Parkinson_vs_control_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void Clasificador_Parkinson_vs_control_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_Clasificador_Parkinson_vs_control_api.c) */
